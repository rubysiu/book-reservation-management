			...
			<div class="main-layout-side">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    <a href="javascript:;"><i class="iconfont">&#xe607;</i>书籍管理</a>
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="/admin/appoint" data-id='1' data-text="预约"><span class="l-line"></span>预约</a></dd>
				      <dd><a href="javascript:;" data-url="/admin/books" data-id='2' data-text="书籍"><span class="l-line"></span>书籍</a></dd>
				    </dl>
				  </li>
...
<%--				  </li>--%>
		...
		<script src="/resources/static/admin/js/main.js" type="text/javascript" charset="utf-8"></script>
