				...
				<ul class="layui-nav layui-nav-tree layui-nav-no-bg" lay-filter="column">
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="column-danye.jsp">关于我们</a>
							</dd>
							<dd>
								<a href="column-danye.jsp">联系我们</a>
							</dd>
							<dd>
								<a href="column-danye.jsp">网站地图</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="column-news.jsp">公司新闻</a>
							</dd>
							<dd>
								<a href="column-news.jsp">行业新闻</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item layui-this">
						<a href="column-news.jsp">产品</a>
					</li>
					<li class="layui-nav-item">
						<a href="column-news.jsp">大数据</a>
					</li>
				</ul>
					...
					<div class="layui-form" id="table-list">
						...
						<div class="page-wrap">
							<ul class="pagination">
								...
								<li>
									<a href="/admin/category/index.jsp?page=2">2</a>
								</li>
								<li>
									<a href="/admin/category/index.jsp?page=2">»</a>
								</li>
							</ul>
						</div>
					</div>
