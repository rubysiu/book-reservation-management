...
<%--					</div>--%>
					...
					<div class="chart-panel panel panel-default">
						<div class="panel-body" id="chart" style="height: 376px;width: 100%;">
							<h1>欢迎,登录书籍预约后台管理系统！</h1>
						</div>
					</div>
					<!--服务器信息-->
...
<%--			</div>--%>
		...
		<script src="/resources/static/admin/lib/echarts/echarts.js"></script>
		<script type="text/javascript">
			layui.use(['layer','jquery'], function(){
				...
				require.config({
				    paths: {
				        echarts: '/resources/static/admin/lib/echarts'
				    }
				});
				require(
				    [
